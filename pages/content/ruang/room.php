            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p>
                            <a href="addroom.php" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#basicModal"><i class="bi bi-person-fill-add"></i> Add Ruangan</a>
                                        ...
                                        <h5 class="modal-title">Tambah data Ruangan</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    ...
                                                    <div class="modal-body">
                                                        apakah kamu ingin menambah data Ruangan?
                                                    </div>
